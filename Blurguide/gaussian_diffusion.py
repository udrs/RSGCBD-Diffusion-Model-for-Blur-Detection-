...
import Blurguide.RulebasedDetection as br
...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        ...
        # save_image(cal,f"/home/agou/vv/MedSegDiff/sampleprocess/cal_{str(t)}.png")
        # save_image(pred_xstart,f"/home/agou/vv/MedSegDiff/sampleprocess/pred_xstart_{str(t)}.png")
        return {
            "mean": model_mean,
