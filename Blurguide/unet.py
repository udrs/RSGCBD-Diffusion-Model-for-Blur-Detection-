...
class ARGCCascade(nn.Module):
    ...
    def forward(self, x):
        ...
        torchvision.utils.save_image(x, '/home/agou/vv/ARGCCascade_Test/1.png')
...
class Generic_UNet(SegmentationNetwork):
    ...
    def forward(self, x, hs = None):
        ...
        # heatmap1 = torch.tensor([0])
        # heatmap2 = torch.tensor([0])
        # heatmap3 = torch.tensor([0])
        # heatmap4 = torch.tensor([0])
        # heatmap5 = torch.tensor([0])
        heatmap = []
        ...
        if not seg_outputs:
            ...
            # visualize_heatmap(self.seg_outputs[0](x),heatmap[0],'heatmap1.png')
            # visualize_heatmap(self.seg_outputs[0](x),heatmap[1],'heatmap2.png')
            # visualize_heatmap(self.seg_outputs[0](x),heatmap[2],'heatmap3.png')
            # visualize_heatmap(self.seg_outputs[0](x),heatmap[3],'heatmap4.png')
            # visualize_heatmap(self.seg_outputs[0](x),heatmap[4],'heatmap5.png')
            # visualize_heatmap(self.seg_outputs[0](x),x,'heatmap6.png')
            # import torchvision
            # torchvision.utils.save_image(x, '/home/agou/vv/Medsegdiff/1.png')

            # pred = self.seg_outputs[0](x) # 1*256*256
            # visualize_heatmap(pred,heatmap[0],'heatmap1.png') # 480*8
            # visualize_heatmap(pred,heatmap[1],'heatmap2.png') # 256*16
            # visualize_heatmap(pred,heatmap[2],'heatmap3.png') # 128*32
            # visualize_heatmap(pred,heatmap[3],'heatmap4.png') # 64*64
            # visualize_heatmap(pred,heatmap[4],'heatmap5.png') # 32*128
            # visualize_heatmap(pred,x,'heatmap6.png')          # 32*256
